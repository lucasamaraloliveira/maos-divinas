      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="relative order-2 lg:order-1 opacity-0 animate-reveal-right">
            <div className="absolute -top-10 -left-10 w-48 md:w-64 h-48 md:h-64 bg-[#fcf8f0] -z-10 rounded-full animate-pulse"></div>
            ...
            <div className="absolute -bottom-6 -right-6 bg-[#d4af37] p-6 md:p-10 hidden sm:block z-20 shadow-xl transform hover:rotate-3 transition-transform duration-500">
          ...
          <div className="space-y-6 md:space-y-8 order-1 lg:order-2 opacity-0 animate-reveal-up">
            <h3 className="text-[#d4af37] uppercase tracking-[0.3em] font-semibold text-xs md:text-sm">Nossa Filosofia</h3>
            ...
            <div className="pt-4 grid grid-cols-2 gap-6">
              <div className="border-l-2 border-[#d4af37] pl-4 group">
                <h4 className="font-serif text-3xl md:text-4xl text-[#d4af37] group-hover:scale-110 origin-left transition-transform">10+</h4>
                <p className="uppercase text-[10px] tracking-widest text-gray-400 mt-2 font-bold">Anos de Experiência</p>
              </div>
              <div className="border-l-2 border-[#d4af37] pl-4 group">
                <h4 className="font-serif text-3xl md:text-4xl text-[#d4af37] group-hover:scale-110 origin-left transition-transform">5k+</h4>
