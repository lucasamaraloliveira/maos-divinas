  ...
  return (
    ...
    >
      <div className="flex items-center">
        <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-xs group-hover:mr-4 transition-all duration-700 ease-in-out uppercase text-[10px] tracking-[0.2em] font-bold opacity-0 group-hover:opacity-100">
          Agendar WhatsApp
        </span>
        <svg
